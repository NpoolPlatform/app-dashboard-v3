<template>
  ...
  >
    <q-card class='popup-menu'>
      ...
      <q-item class='row'>
        <LoadingButton :loading='true' :label='$t("MSG_APPROVE")' @click='onApprove' :disabled='target.State !== reviewbase.ReviewState.Wait' />
        <LoadingButton :loading='true' :label='$t("MSG_REJECT")' @click='onReject' :disabled='target.State !== reviewbase.ReviewState.Wait' />
...
const onApprove = (done: () => void) => {
  ...
  updateCouponWithdrawReview(done)
}
...
const getCouponWithdrawReviews = (offset: number, limit: number) => {
  review.getCouponWithdrawReviews({
    Offset: offset,
    Limit: limit,
    Message: {
      Error: {
    ...
    getCouponWithdrawReviews(offset + limit, limit)
  })
}

const updateCouponWithdrawReview = (done: () => void) => {
  review.updateCouponWithdrawReview({
    ID: target.value.ID,
