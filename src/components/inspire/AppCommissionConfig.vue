...
const updateAppCommissionConfig = (done: () => void) => {
  _commconfig.updateAppCommissionConfig({
    ...target.value,
    Message: {
      Error: {
...
const createAppCommissionConfig = (done: () => void) => {
  _commconfig.createAppCommissionConfig({
    ...target.value,
    Message: {
      Error: {
...
const updateAppGoodCommissionConfig = (done: () => void) => {
  _commgoodconfig.updateAppGoodCommissionConfig({
    ...target2.value,
    Message: {
      Error: {
...
const createAppGoodCommissionConfig = (done: () => void) => {
  _commgoodconfig.createAppGoodCommissionConfig({
    ...target2.value,
    Message: {
      Error: {
...
const getAppCommissions = (offset: number, limit: number) => {
  _commconfig.getAppCommissionConfigs({
    Offset: offset,
    Limit: limit,
    Message: {
      Error: {
...
const getAppGoodCommissions = (offset: number, limit: number) => {
  _commgoodconfig.getAppGoodCommissionConfigs({
    Offset: offset,
    Limit: limit,
    Message: {
      Error: {
